...
export declare const CREATE_NOTIFICATION_ERROR_MSG = "OpenFin API call Notification.constructor failed.";
export declare const NOTIFICATION_GET_CURRENT_ERROR_MSG = "OpenFin API call Notification.getCurrent failed.";
export declare const NOTIFICATION_CLOSE_ERROR_MSG = "OpenFin API call Notification.close failed.";
export declare const NOTIFICATION_SEND_MSG_ERROR_MSG = "OpenFin API call Notification.sendMessage failed.";
export declare const NOTIFICATION_SEND_MSG_TO_APP_ERROR_MSG = "OpenFin API call Notification.sendMessageToApplication failed.";
...
export interface CreateNotificationPayload extends BaseRequestPayload {
    ...
    onClose?: () => void;
    onDismiss?: () => void;
    onError?: (reason: string, errorObj: any) => void;
    onMessage?: (message: any) => void;
    onShow?: (successObj: any) => void;
}
