...
export declare const FIN_NOT_INJECTED_MSG = "fin handler is not injected or initialized";
export declare const LIB_REDUX_DISPATCH_FIELD_NAME = "REDUX_OPENFIN_LIB_REDUX_DISPATCH_FIELD_NAME";
...
export declare type FinWindowState = 'minimized' | 'maximized' | 'restored';
export declare type FinWindowBounds = {
    height: number;
    left: number;
    top: number;
    width: number;
...
export interface WindowOptions {
    ...
    smallWindow: boolean;
    state: string;
    taskbarIconGroup: any;
    string: any;
    url: string;
    uuid: string;
    waitForPageLoad: boolean;
}
export declare type ErrorCallback = (error: Object) => void;
declare type FinCallback = (...args: any[]) => void;
declare type FinErrCallback = (reason: string | Error) => void;
export interface LegacyFinWindow {
    name: string;
    constructor: (options: {
        name: string;
    }, callback?: () => void, errorCallback?: ErrorCallback) => LegacyFinWindow;
...
export interface FinWindow {
    ...
    setBounds: (bounds: {
        ...
        width: number;
        height: number;
    } | Partial<FinWindowBounds>) => Promise<void>;
