...
var InterApplicationBus = (function (_super) {
    ...
    InterApplicationBus.publish = function (topic, message) {
    ...
    InterApplicationBus.subscribe = function (senderUuid, name, topic, listener) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!InterApplicationBus.listeners[topic]) {
    ...
    InterApplicationBus.Channel = OpenFinMockV2_1.OpenFinMockV2.generateMethods('InterApplicationBus.Channel', Channel_1.Channel);
